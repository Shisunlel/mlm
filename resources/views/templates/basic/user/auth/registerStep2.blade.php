        ...
        <div class="container">
            ...
            <div class="check_group">
                <div class="mt-5 d-flex justify-content-end">
                    <label for="select_all">{{ __('form.agree_all') }}<input type="checkbox"
                            class="input-icheck check_all"></label>
                </div>
                <div class="row my-2">
                    <div class="col-12 my-2">
                        ...
                        <div class="d-flex justify-content-end mt-2">
                            <label for="agreement">{{ __('form.agree') }}<input type="checkbox" class="input-icheck agree"
                                    form="agree_form"></label>
                        </div>
                    </div>
                    <div class="col-12 my-2">
                        ...
                        <div class="d-flex justify-content-end mt-2">
                            <label for="tos">{{ __('form.agree') }}<input type="checkbox" class="input-icheck agree"
                                    form="agree_form"></label>
                        </div>
                    </div>
                    <div class="col-12 my-2">
                        ...
                        <div class="d-flex justify-content-end mt-2">
                            <label for="privacy">{{ __('form.agree') }}<input type="checkbox" class="input-icheck agree"
                                    form="agree_form"></label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row d-flex justify-content-end">
                <div class="col-5 col-md-3">
                    <a href="{{ route('user.register') }}" class="btn form-control">{{ __('form.back') }}</a>
                </div>
                <div class="col-5 col-md-3">
                    <form action="{{ route('user.register.step3') }}" id="agree_form">
