                                ...
                                <form class="create-account-form form-row" method="post"
                                    ...
                                    @if ($ref_user == null)
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="form-group ">
                                                ...
                                                <span id="position-test"><span class="text-danger">@lang('Please enter
                                                        referral username first')</span></span>
                                            </div>
                                        </div>
                                    @else
                                        <div class="col-md-6 ">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <input type="text" name="firstname" value="{{ old('firstname') }}"
                                                autocomplete="off" placeholder="@lang('Enter your first name')*" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="input-group mb-3 input-group-custom">
                                            <div class="input-group-prepend">
                                                <select name="country_code" class="input-group-text" readonly>
                                                    ...
                                                    <option value="855" data-country="Cambodia" data-code="KH" selected>
                                                        @lang("+855")</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($general->secure_password)
                                            ...
                                            <p class="text-danger my-1 special">@lang('At least 1 special character is
                                                required')</p>
                                        @endif
                                    </div>
                                    <div class="col-md-6">
