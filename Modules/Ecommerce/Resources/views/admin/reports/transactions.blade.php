        ...
        <div class="col-lg-12">
            <div class="card b-radius--10">
                <div class="card-body">
                    <div class="row justify-content-end">
                        <div class="col-lg-3 mb-3">
                            @if(request()->routeIs('ecommerce.admin.users.transactions'))
                            ...
                            <form action="{{ route('ecommerce.admin.report.transaction.search') }}" method="GET" >
                                <div class="input-group has_append">
                        ...
                        <div class="col-lg-3">
                            ...
                            <form action="
                                @if(request()->routeIs('ecommerce.admin.report.transaction') ||request()->routeIs('ecommerce.admin.report.transaction.search'))
                                {{ route('ecommerce.admin.report.transaction.search') }}
                                @else
                                    {{ route('ecommerce.admin.report.transaction.user_search', $user->id) }}
                                @endif
                                " method="GET"
                            >
                                <div class="input-group has_append ">
                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($transactions as $trx)
                                <tr>
                                    ...
                                    <td data-label="@lang('Customer')"><a href="{{ route('ecommerce.admin.users.detail', $trx->user_id) }}">{{ @$trx->user->username }}</a></td>
                ...
                <div class="card-footer py-4">
                    {{ $transactions->links('ecommerce::admin.partials.paginate') }}
                </div>
            </div><!-- card end -->
        </div>
    </div>
