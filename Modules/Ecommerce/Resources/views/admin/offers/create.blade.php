...
<div class="row">
    <div class="col-lg-12">
        <form action="{{ route('ecommerce.admin.offer.store', $offer->id??0) }}" method="POST" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10 col-md-9">
                                    ...
                                    <select class="form-control" id="products" name="products[]" multiple required>
                                        @if(request()->routeIs('ecommerce.admin.offer.edit'))
...
@push('breadcrumb-plugins')
    <a href="{{ route('ecommerce.admin.offer.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-backward"></i>@lang('Go Back')</a>
@endpush
