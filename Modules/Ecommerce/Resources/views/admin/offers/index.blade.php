                            ...
                            @forelse($offers as $offer)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{ route('ecommerce.admin.offer.edit', $offer->id) }}" data-toggle="tooltip" data-placement="top" title="@lang('Edit')"class="icon-btn edit-btn">
...
@push('breadcrumb-plugins')
    <a href="{{ route('ecommerce.admin.offer.create') }}" class="btn btn-sm btn--success box--shadow1 text--small"> <i class="las la-plus"></i> @lang('Add New')</a>
@endpush
    ...
    <script>
        ...
        (function($){
            $('.delete-btn').on('click', function ()
            {
                ...
                form.action = '{{ route('ecommerce.admin.offer.delete', '') }}' + '/' + id;
                modal.modal('show');
            ...
            $('.change_status').on('change',function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('ecommerce.admin.offer.status') }}",
                    method: 'POST',
                    data: data,
