...
<div class="row">
    <div class="col-lg-12">
        <form action="{{ route('ecommerce.admin.coupon.store', $coupon->id??0) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10 col-md-9">
                                    ...
                                    <select class="form-control" id="products" name="products[]" multiple>
                                        @if(request()->routeIs('ecommerce.admin.coupon.edit'))
...
@push('breadcrumb-plugins')
    <a href="{{ route('ecommerce.admin.coupon.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-backward"></i>@lang('Go Back')</a>
@endpush
