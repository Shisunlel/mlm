                            ...
                            @forelse($coupons as $coupon)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{ route('ecommerce.admin.coupon.edit', $coupon->id) }}" data-toggle="tooltip" data-placement="top" title="@lang('Edit')"class="icon-btn edit-btn">
...
@push('breadcrumb-plugins')
    <a href="{{ route('ecommerce.admin.coupon.create') }}" class="btn btn-sm btn--success box--shadow1 text--small"> <i class="las la-plus"></i> @lang('Add New')</a>
    ...
    <script>
        ...
        (function($){
            $('.delete-btn').on('click', function ()
            {
                ...
                form.action = '{{ route('ecommerce.admin.coupon.delete', '') }}' + '/' + id;
                modal.modal('show');
            ...
            $('.change_status').on('change',function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('ecommerce.admin.coupon.status') }}",
                    method: 'POST',
                    data: data,
