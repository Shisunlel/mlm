...
@push('breadcrumb-plugins')
    @if(request()->routeIs('ecommerce.admin.users.login.history'))
    <form action="{{ route('ecommerce.admin.users.login.history') }}" method="GET" class="form-inline float-sm-right bg--white">
