    ...
    <div class="col-lg-12">
        <div class="card b-radius--10 ">
            <div class="card-body">
                ...
                <div class="row justify-content-end">
                    <div class="col-lg-4 mb-3">
                        <form action="{{ request()->routeIs('ecommerce.admin.brand.trashed')?route('ecommerce.admin.brand.trashed.search'):route('ecommerce.admin.brand.search') }}"
                            method="GET">
            ...
            <div class="card-footer py-4">
                {{ $brands->appends(['search'=>request()->search ?? null])->links('ecommerce::admin.partials.paginate') }}
            </div>
        </div>
    </div>
</div>
...
<div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content ">
            ...
            <form action="{{ route('ecommerce.admin.brand.store', 0) }}" method="POST" enctype="multipart/form-data">
...
@push('breadcrumb-plugins')
    @if(request()->routeIs('ecommerce.admin.brand.all'))
    ...
    @else
        @if(request()->routeIs('ecommerce.admin.brand.trashed.search'))
            <a href="{{ route('ecommerce.admin.brand.trashed') }}"
                class="btn btn-sm btn--primary box--shadow1 text--small">
                <i class="la la-fw la-backward"></i> @lang('Go Back')
            </a>
        @else
            <a href="{{ route('ecommerce.admin.brand.all') }}"
                class="btn btn-sm btn--primary box--shadow1 text--small">
                <i class="la la-fw la-backward"></i> @lang('Go Back')
            </a>
        @endif
    ...
    @if(request()->routeIs('ecommerce.admin.brand.all'))
        <a href="{{ route('ecommerce.admin.brand.trashed') }}" class="btn btn-sm btn--danger box--shadow1 text--small"><i class="las la-trash-alt"></i>@lang('Trashed')</a>
    @endif
@endpush
    ...
    <script>
        ...
        (function($){
            ...
            $('.edit-btn').on('click', function () {
                ...
                form.action = '{{ route('ecommerce.admin.brand.store', '') }}' + '/' + brand.id;
            ...
            $('.delete-btn').on('click', function ()
            {
                ...
                form.action = '{{ route('ecommerce.admin.brand.delete', '') }}' + '/' + id;
                modal.modal('show');
            });
            ...
            $('.top_brand').on('change', function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('ecommerce.admin.brand.settop') }}",
                    method: 'POST',
                    data: data,
