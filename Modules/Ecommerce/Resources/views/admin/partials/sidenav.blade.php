<div class="sidebar capsule--rounded bg_img overlay--dark" data-background="{{getImage('assets/admin/images/sidebar/2.jpg','400x800')}}"
    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{route('ecommerce.admin.dashboard')}}" class="sidebar__main-logo"><img
                    src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}" alt="@lang('image')"></a>
            <a href="{{route('ecommerce.admin.dashboard')}}" class="sidebar__logo-shape"><img
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.users*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                <a href="{{route('ecommerce.admin.users.all')}}" class="nav-link">
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.active')}} ">
                                <a href="{{route('ecommerce.admin.users.active')}}" class="nav-link">
                                    <i class="menu-icon las la-user-check"></i>
                                    <span class="menu-title">@lang('Active Customers')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.users.banned')}} ">
                                <a href="{{route('ecommerce.admin.users.banned')}}" class="nav-link">
                                ...
                                <a href="{{route('ecommerce.admin.users.login.history')}}" class="nav-link">
                    ...
                    <div class="sidebar-submenu {{menuActive(['admin.deposit.pending', 'admin.deposit.approved', 'admin.deposit.successful', 'admin.deposit.rejected', 'admin.deposit.list*', 'admin.deposit.search'],2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.deposit.list')}} ">
                                <a href="{{route('ecommerce.admin.deposit.list')}}" class="nav-link">
                                    <i class="menu-icon las la-list-ul"></i>
                                    <span class="menu-title">@lang('All Payments')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.deposit.pending')}} ">
                                <a href="{{route('ecommerce.admin.deposit.pending')}}" class="nav-link">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.ticket*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.ticket')}} ">
                                <a href="{{route('ecommerce.admin.ticket')}}" class="nav-link">
                                    <i class="menu-icon las la-list"></i>
                                    <span class="menu-title">@lang('All Ticket')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.ticket.pending')}} ">
                                <a href="{{route('ecommerce.admin.ticket.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-pause-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.ticket.closed')}} ">
                                <a href="{{route('ecommerce.admin.ticket.closed')}}" class="nav-link">
                                    <i class="menu-icon las la-times-circle"></i>
                                    <span class="menu-title">@lang('Closed Ticket')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.ticket.answered')}} ">
                                <a href="{{route('ecommerce.admin.ticket.answered')}}" class="nav-link">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.seo')}}">
                    <a href="{{route('ecommerce.admin.seo')}}" class="nav-link">
                    ...
                    <div class="sidebar-submenu {{menuActive(['admin.deposit.manual.*', 'admin.deposit.gateway.*'],2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.deposit.gateway.*')}} ">
                                <a href="{{route('ecommerce.admin.deposit.gateway.index')}}" class="nav-link">
                                    <i class="menu-icon lab la-amazon-pay"></i>
                                    <span class="menu-title">@lang('Automatic Gateways')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.deposit.manual.*')}} ">
                                <a href="{{route('ecommerce.admin.deposit.manual.index')}}" class="nav-link">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.shipping-methods*') }}">
                    <a href="{{ route('ecommerce.admin.shipping-methods.all') }}" class="nav-link">
                    ...
                    <div class="sidebar-submenu {{menuActive(['admin.setting*', 'admin.language*', 'admin.plugin*'],2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.setting.index')}}">
                                <a href="{{route('ecommerce.admin.setting.index')}}" class="nav-link">
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.setting.logo-icon')}}">
                                <a href="{{route('ecommerce.admin.setting.logo-icon')}}" class="nav-link">
                            ...
                            <li class="sidebar-menu-item  {{menuActive(['admin.language-manage','admin.language-key'])}}">
                                <a href="{{route('ecommerce.admin.language-manage')}}" class="nav-link"
                                   data-default-url="{{ route('ecommerce.admin.language-manage') }}">
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.plugin.index')}}">
                                <a href="{{route('ecommerce.admin.plugin.index')}}" class="nav-link">
                ...
                <li class="sidebar-menu-item {{menuActive('clear-cache')}} ">
                    <a href="{{ route('ecommerce.clear-cache') }}" class="nav-link">
                        <i class="menu-icon las la-history"></i>
