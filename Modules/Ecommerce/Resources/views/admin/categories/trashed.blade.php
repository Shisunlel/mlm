    ...
    <div class="col-lg-12">
        <div class="card b-radius--10 ">
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-end">
                    <div class="col-lg-4 mb-3">
                        <form action="{{ route('ecommerce.admin.category.trashed.search') }}" method="GET">
            ...
            <div class="card-footer py-4">
                {{ $categories->appends(['search'=>request()->search ?? null])->links('ecommerce::admin.partials.paginate') }}
            </div>
    ...
    <script>
        ...
        (function($){
            ...
            $('#deleteModal').on('show.bs.modal', function (e) {
                ...
                form.action = '{{ route('ecommerce.admin.category.delete', '') }}' +
                    '/' + id;
            });
        })(jQuery)
    </script>
