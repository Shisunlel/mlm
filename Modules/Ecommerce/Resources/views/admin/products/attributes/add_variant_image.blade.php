...
<a href="{{ route('ecommerce.admin.products.attribute-add', $variant->product->id) }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-backward"></i>@lang('Go Back')</a>
@endpush
