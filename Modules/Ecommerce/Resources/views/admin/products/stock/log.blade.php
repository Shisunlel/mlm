    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-footer py-4">
                <nav aria-label="...">
                    {{ $stock_logs->links('ecommerce::admin.partials.paginate') }}
                </nav>
            </div>
...
<a href="{{ route('ecommerce.admin.products.stock.create', $product_stock->product->id) }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-backward"></i>@lang('Go Back')</a>
@endpush
