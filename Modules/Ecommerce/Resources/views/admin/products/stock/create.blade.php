                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{route('ecommerce.admin.products.stock.log', $item['stock_id']??0)}}" class="icon-btn btn--info" data-toggle="tooltip" data-title="@lang('See Logs')"><i class="fas fa-list"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <table class="table table--light">
                                <tr>
                                    <td colspan="100%" class="text-center"><h3 class="text--danger">@lang('You did\'t add any variant for this product yet. ')</h3>
                                        <a class="btn btn--dark mt-3" href="{{ route('ecommerce.admin.products.attribute-add', [$product->id]) }}">@lang('Add Variant')</a>
                                    </td>
                                </tr>
                            ...
                            <table class="table table--light">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('ecommerce.admin.products.stock.log', $product->stocks[0]??0)}}" class="icon-btn btn--info" data-toggle="tooltip" data-title="@lang('See Logs')"><i class="fas fa-list"></i></a>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <div class="modal fade" id="editModal">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{route('ecommerce.admin.products.stock.add', $product->id)}}" method="POST">
                        @csrf
