    ...
    <div class="col-lg-12">
        <div class="card">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td data-lable="@lang('Product')">
                                <a href="{{route('ecommerce.admin.products.edit', [$item->product->id, slug($item->product->name)])}}">{{__($item->product->name)}}</a>
                            </td>
                            ...
                            <a class="btn btn-primary" href="{{route('ecommerce.admin.products.stock.create', $item->product->id)}}" role="button"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
            ...
            <div class="card-footer py-4">
                <nav aria-label="...">
                    {{$stock_data->links('ecommerce::admin.partials.paginate')}}
                </nav>
            </div>
