...
<div class="row justify-content-center">
    ...
    <div class="col-lg-12">
        <form action="{{ route('ecommerce.admin.products.product-store', isset($product)?$product->id:0) }}" id="addForm" method="POST"
                            ...
                            <select class="select2-multi-select form-control" name="categories[]" id="categories" multiple required">
                                @foreach ($categories as $category)
                                    ...
                                    @foreach ($category->allSubcategories as $subcategory)
                                        @include('ecommerce::admin.partials.subcategories', ['subcategory' => $subcategory, 'prefix'=>$prefix])
            ...
            <div class="card p-2 my-3">
                ...
                @if(request()->routeIs('ecommerce.admin.products.edit'))
                                ...
                                <div class="payment-method-header d-flex flex-wrap">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" name="main_image" class="profilePicUpload" id="image" accept=".png, .jpg, .jpeg" @if(request()->routeIs('ecommerce.admin.products.create'))required @endif>
...
<a href="{{ route('ecommerce.admin.products.all') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-backward"></i>@lang('Go Back')</a>
@endpush
