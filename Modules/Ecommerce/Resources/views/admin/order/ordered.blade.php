    ...
    <div class="col-lg-12">
        <div class="card b-radius--10 ">
                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                                ...
                                @if(!request()->routeIs('ecommerce.admin.order.cod'))
                                <th class="text-left">@lang('Payment Via')</th>
                                @endif
                                <th class="text-right">@lang('Amount')</th>
                                @if(request()->routeIs('ecommerce.admin.order.index'))
                                    <th>@lang('Status')</th>
                                @endif
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td data-label="Customer" class="text-left">
                                    <a href="{{ route('ecommerce.admin.users.detail', $item->user->id) }}">{{ $item->user->id }}</a>
                                </td>
                                ...
                                <td data-label="Action" class="text-center">
                                    ...
                                    <a href="{{ route('ecommerce.admin.order.details', $item->id) }}" data-toggle="tooltip" title="@lang('View')" class="icon-btn btn--dark mr-1">
                                        <i class="la la-desktop"></i>
                                    </a>

                                    @if(!request()->routeIs('ecommerce.admin.order.notpaid'))
            ...
            <div class="card-footer py-4">
                {{ $orders->links('ecommerce::admin.partials.paginate') }}
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="approveModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form action="{{ route('ecommerce.admin.order.status') }}" method="POST" id="deliverPostForm">
            @csrf
