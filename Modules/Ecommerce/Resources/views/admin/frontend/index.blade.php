...
@section('panel')
            ...
            <div class="col-lg-12 col-md-12 mb-30">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('ecommerce.admin.frontend.sections.content', $key)}}" method="POST"
    ...
    @if(@$section->element)
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        ...
                                        @else
                                            ...
                                            <a href="{{route('ecommerce.admin.frontend.sections.element',[$key,$data->id])}}" class="icon-btn"><i class="la la-pencil-alt"></i></a>
                                        @endif
        ...
        <div id="updateBtn" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('ecommerce.admin.frontend.sections.content', $key) }}" class="edit-route" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="type" value="element">
        ...
        <div id="removeModal" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('ecommerce.admin.frontend.remove') }}" method="POST">
                        @csrf
        ...
        @push('breadcrumb-plugins')
            ...
            @else
                <a href="{{route('ecommerce.admin.frontend.sections.element',$key)}}" class="btn btn-sm btn--success box--shadow1 text--small"><i class="la la-plus"></i>@lang('Add New')</a>
            @endif
        @endpush
        @endif
    @endif
