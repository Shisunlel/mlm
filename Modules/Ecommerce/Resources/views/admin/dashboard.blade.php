            ...
            <div class="widget bb--3 border--dark b-radius--10 bg--white p-4 box--shadow2 has--link">
                ...
                <div class="widget__content">
                    ...
                    <p class="mt-10 text-right">
                        <a class="btn btn-sm btn--dark" href="{{route('ecommerce.admin.order.index')}}">@lang('View All')
                        </a>
                    </p>
                </div>
            </div><!-- widget end -->
        ...
        <div class="col-xl-4 col-md-6 mb-30">
            <div class="widget bb--3 border--teal b-radius--10 bg--white p-4 box--shadow2 has--link">
                ...
                <div class="widget__content">
                    ...
                    <p class="mt-10 text-right">
                        <a class="btn btn-sm bg--teal text-white" href="#">@lang('View All')
                        </a>
                    </p>
                </div>
            </div><!-- widget end -->
        ...
        <div class="col-xl-4 col-md-6 mb-30">
            <div class="widget bb--3 border--light-blue b-radius--10 bg--white p-4 box--shadow2 has--link">
                ...
                <div class="widget__content">
                    ...
                    <p class="mt-10 text-right">
                        <a class="btn btn-sm bg--light-blue text-white" href="{{ route('ecommerce.admin.products.all') }}">@lang('View All')
                        </a>
                    </p>
                </div>
            </div><!-- widget end -->
                ...
                <div class="card-body">
                    ...
                    @foreach ($widget['top_selling_products'] as $item)
                        ...
                        <div class="d-flex flex-wrap single-product mt-30">
                            <a href="{{ route('ecommerce.product.details', [$item->id, slug($item->name)]) }}" data-toggle="tooltip" data-placement="bottom" title="@lang('View As Customer')" class="col-md-2 text-center"><img src="{{ getImage(imagePath()['product']['path']. '/thumb_'. @$item->main_image, imagePath()['product']['size']) }}" alt="image"></a>

                            <div class="col-md-10 mt-md-0 mt-3">
                                <a href="{{ route('ecommerce.admin.products.edit', [$item->id, slug($item->name)]) }}" data-toggle="tooltip" data-placement="top" title="@lang('Edit')" class="text--blue font-weight-bold d-inline-block mb-2">{{ __($item->name) }}</a>
                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($latestUser as $user)
                                <tr>
                                    ...
                                    <td data-label="@lang('Username')"><a href="{{ route('ecommerce.admin.users.detail', $user->id) }}">{{ $user->username }}</a></td>
                                    <td data-label="@lang('Email')">{{ $user->email }}</td>
                                    <td data-label="@lang('Order')">{{ $user->orders->count() }}</td>
                                    <td data-label="@lang('Action')">
                                        <a href="{{ route('ecommerce.admin.users.detail', $user->id) }}" class="icon-btn" data-toggle="tooltip" data-original-title="@lang('Details')">
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('ecommerce.admin.order.details', $order->id)}}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="Details">
                                            <i class="las la-desktop text--shadow"></i>
                                        </a>
                                    </td>
                                </tr>
