    ...
    <div class="col-lg-12">
        <div class="card b-radius--10">
            ...
            <div class="card-footer py-4">
                <nav aria-label="...">
                    {{ $attributes->links('ecommerce::admin.partials.paginate') }}
                </nav>
            </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('ecommerce.admin.attributes.store', 0) }}" method="POST">
                    @csrf
...
<script>
    ...
    (function ($) {
        $('.editBtn').on('click', function () {
            ...
            form.action = '{{route('ecommerce.admin.attributes.store', '')}}'+'/'+id;
            modal.modal('show');
        });
    })(jQuery)
</script>
