            ...
            @if($top_categories->count()>0)
                <div class="col-lg-6 padding-bottom-half padding-top-half">
                    <div class="section-header-2">
                        ...
                        <a href="{{ route('ecommerce.categories') }}" class="custom-button theme btn-sm">@lang('View All')</a>
                    </div>
                    <div class="m--10">
                        <div class="category-slider owl-theme owl-carousel">
                            ...
                            @foreach ($top_categories as $item)
                                <div class="cate-item">
                                    <a href="{{ route('ecommerce.products.category', ['id'=>$item->id, 'slug'=>slug($item->name)]) }}" class="cate-inner">
            ...
            @if($top_brands->count()>0)
                <div class="col-lg-6 padding-bottom-half padding-top-half">
                    <div class="section-header-2">
                        ...
                        <a href="{{ route('ecommerce.brands') }}" class="custom-button theme btn-sm">@lang('View All')</a>
                    </div>
                    <div class="m--10">
                        <div class="category-slider owl-theme owl-carousel">
                            @foreach ($top_brands as $item)
                                <div class="cate-item">
                                    <a href="{{ route('ecommerce.products.brand', ['id'=>$item->id, 'slug'=>slug($item->name)]) }}" class="cate-inner">
