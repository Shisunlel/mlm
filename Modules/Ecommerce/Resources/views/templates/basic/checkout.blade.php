                        ...
                        <div class="checkout-wrapper">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show fade active" id="self">
                                    <form action="{{route('ecommerce.user.checkout-to-payment', 1)}}" method="post" class="billing-form mb--20">
                                        @csrf
                                            ...
                                            <div class="col-lg-6 mb-20">
                                                ...
                                                <div class="billing-select">
                                                    <select name="country" id="country" class="select-bar" required>
                                                        @include('ecommerce::partials.country')
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row justify-content-end">
                                            ...
                                            @endif
                                            <div class="col-lg-6 mb-20">
                                                <button type="" name="payment" value="1" class="bill-button">@lang('Continue to Payment')</button>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="guest">
                                    <form action="{{route('ecommerce.user.checkout-to-payment', 2)}}" method="post" class="guest-form mb--20">
                                        @csrf
...
@push('breadcrumb-plugins')
    <li><a href="{{route('ecommerce.home')}}">@lang('Home')</a></li>
    <li><a href="{{route('ecommerce.products')}}">@lang('Products')</a></li>
    <li><a href="{{route('ecommerce.shopping-cart')}}">@lang('Cart')</a></li>
@endpush
