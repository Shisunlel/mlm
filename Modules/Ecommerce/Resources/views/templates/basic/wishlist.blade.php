            ...
            @forelse ($wishlist_data as $item)
                ...
                <tr>
                    <td data-label="@lang('Product')">
                        <a href="{{route('ecommerce.product.detail', ['id'=>$item->product->id, 'slug'=>slug($item->product->name)])}}" class="cart-item mw-100">
                            <div class="cart-img">
        ...
        <div class="cart-total section-bg rounded--5">
            ...
            <div class="d-flex flex-wrap align-items-center">
                ...
                <div class="checkout ml-auto">
                    <a href="{{route('ecommerce.home')}}" class="theme custom-button">@lang('Continue Shopping')</a>
                </div>
            </div>
        </div>
    </div>
