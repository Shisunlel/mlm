...
<div class="invoice-history-section padding-bottom padding-top">
    <div class="container border">
        ...
        <div class="float-right">
            <a href="{{ route('ecommerce.print.invoice', $order->id) }}" target=blank class="btn btn-dark mt-3"><i class="fa fa-print"></i>@lang('Print')</a>
        </div>
    </div>
</div>
...
@push('breadcrumb-plugins')
    ...
    <li><a href="{{route('ecommerce.user.orders', 'all')}}">@lang('Orders')</a></li>
@endpush
