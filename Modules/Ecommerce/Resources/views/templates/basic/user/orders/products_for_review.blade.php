        ...
        <div class="row">
            <div class="col-xl-3">
                <div class="dashboard-menu">
                    @include('ecomemrce::'.$activeTemplate.'user.partials.dp')
                    <ul>
                        @include('ecomemrce::'.$activeTemplate.'user.partials.sidebar')
                    </ul>
                </div>
            </div>
            <div class="col-xl-9">
                <table class="regular-table section-bg">
                    ...
                    <tbody>
                        @forelse ($products as $item)
                            <tr>
                                <td>
                                    <a href="{{route('ecommerce.product.detail', ['id'=>$item->id, 'slug'=>slug($item->name)])}}" class="cart-item">
                                        <div class="cart-img">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="add-review">
                    <form action="{{route('ecommerce.user.product.review')}}" method="POST" class="review-form rating row">
                        @csrf
