                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Order ID')">
                                <a href="{{route('ecommerce.user.order', $order->order_number)}}" class="text-info">{{$order->order_number}}</a>
                            </td>
                            ...
                            <td data-label="@lang('Action')" class="text-center">
                                <a href="{{route('ecommerce.user.order', $order->order_number)}}" class="btn-normal-2 btn-sm"> <i class="fas fa-desktop"></i></a>
...
@push('breadcrumb-plugins')
    <li><a href="{{route('ecommerce.user.home')}}">@lang('Dashboard')</a></li>
@endpush
