@php
    $footer    = getModuleContent('footer.content', true);
    if($footer)
    ...
    <div class="container">
        <div class="footer-bottom">
                ...
                <ul>
                    @if($pages->count() > 0)
                        @foreach ($pages as $item)
                            <li><a href="{{route('ecommerce.pages', ['id' => $item->id, 'slug'=> slug($item->data_values->page_title) ])}}">@php echo __($item->data_values->page_title) @endphp</a></li>
                        @endforeach
                    @endif
                </ul>
            </div>
            <div class="footer-widget widget-link">
                ...
                <ul>
                    <li><a href="{{route('ecommerce.about_us')}}">@lang('About Us')</a></li>
                    <li><a href="{{route('ecommerce.contact')}}">@lang('Contact Us')</a></li>
                    <li><a href="{{route('ecommerce.faqs')}}">@lang('FAQ')</a></li>
        ...
        <div class="footer-copyright">
            <div class="copyright-area d-flex flex-wrap align-items-center justify-content-between">
                ...
                <ul class="social-icons">
                    @php
                        $socials    = getModuleContent('social_icon.element');
                    @endphp
