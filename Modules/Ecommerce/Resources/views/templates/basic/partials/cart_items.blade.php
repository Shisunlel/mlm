...
<div class="single-product-item">
    ...
    <div class="content">
        <h4 class="title"><a class="cl-white" href="{{route('ecommerce.product.detail', ['id'=>$item->product->id, 'slug'=>slug($item->product->name)])}}">{{ __($item->product->name) }}</a></h4>
        <div class="price">
            <span class="pprice">
                {{$general->cur_sym}}@php
...
<div class="btn-wrapper text-center">
    <a href="{{route('ecommerce.shopping-cart')}}" class="custom-button btn-block">@if($more> 0)
