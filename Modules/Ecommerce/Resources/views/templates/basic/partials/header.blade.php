...
<header>
                    ...
                    <ul>
                        @if ($pages->count() > 0)
                            @foreach ($pages as $item)
                                <li><a
                                        href="{{ route('ecommerce.pages', ['id' => $item->id, 'slug' => slug($item->data_values->page_title)]) }}">@php echo __($item->data_values->page_title) @endphp</a>
                                </li>
                            @endforeach
                        @endif

                        <li><a href="{{ route('ecommerce.order-track') }}">@lang('Track Your Order')</a></li>
                    </ul>
                </div>
                <div class="left-side">
    ...
    request()->session()->get('lang'))
                                ...
                                @endif
                                <li>
                                    <a href="{{ route('ecommerce.lang', $lang->code) }}">
                                        <div class="img">
                                            <img src="{{ getImage('assets/images/lang' . '/' . $lang['icon'], '64x64') }}"
                                                alt="@lang('country')">
                                        </div>
        ...
        <div class="container">
            <div class="header-wrapper justify-content-between align-items-center">
                ...
                <ul class="menu ml-auto d-none d-lg-flex">
                    <li>
                        <a href="{{ route('ecommerce.home') }}">@lang('Home')</a>
                    </li>

                    <li>
                        <a href="{{ route('ecommerce.products') }}">@lang('Products')</a>
                    </li>

                    <li>
                        <a href="{{ route('ecommerce.brands') }}">@lang('Brands')</a>
                    </li>
                    <li>
                        <a href="{{ route('ecommerce.contact') }}">@lang('Contact')</a>
                    </li>
                </ul>
    ...
    <div class="header-bottom bg-3 py-3">
        <div class="container">
            <div class="header-bottom-wrapper d-flex flex-wrap justify-content-between align-items-center">
                <div class="view-category d-none d-lg-block  @if (request()->routeIs('ecommerce.home')) d-xl-none @endif">
                ...
                <form action="{{ route('ecommerce.product.search') }}" method="GET"
                    class="header-search-form mr-auto @if (!request()->routeIs('ecommerce.home')) w-100 @endif">
                        ...
                        <select class="select-bar" name="category_id">
                            ...
                            @foreach ($categories as $category)
                                ...
                                @foreach ($category->allSubcategories as $subcategory)
                                    @include('ecommerce::'.$activeTemplate.'partials.subcategories', ['subcategory' =>
                                    $subcategory, 'prefix'=>$prefix])
                ...
                @if (request()->routeIs('ecommerce.home'))
                ...
                <ul class="shortcut-icons">
                    ...
                    <li>
                        <a href="{{ route('ecommerce.compare') }}">
            ...
            <div class="pos-rel d-none d-lg-block @if (request()->routeIs('ecommerce.home')) d-xl-none @endif">
                <div class="left-category single-style">
                    <ul class="categories">
                        @foreach ($categories as $category)
                            <li>
                                <a
                                    href="{{ route('ecommerce.products.category', ['id' => $category->id, 'slug' => slug($category->name)]) }}">
                                ...
                                @if ($category->allSubcategories->count() > 0)
                                    <ul class="sub-category">
                                        @foreach ($category->allSubcategories as $subcategory)
                                            @include('ecommerce::'.$activeTemplate.'partials.menu_subcategories',
...
<div class="mobile-menu d-lg-none">
    ...
    <ul class="nav-tabs nav border-0">
        <li>
            <a href="#menu" class="active" data-toggle="tab">@lang('ecommerce::Menu')</a>
        </li>
        <li>
...
<div class="cart-sidebar-area" id="cart-sidebar-area">
    <div class="top-content">
        <a href="{{ route('ecommerce.home') }}" class="logo">
            <img src="{{ getImage('assets/images/logoIcon/logo.png', '183x54') }}" alt="@lang('logo')">
        </a>
...
<div class="dashboard-menu before-login-menu d-flex flex-wrap justify-content-center flex-column">
            ...
            <form method="POST" action="{{ route('user.login') }}" class="sign-in-form">
                ...
                <div class="pt-2 mb-0">
                    <p class="create-accounts">
                        <a href="{{ route('ecommerce.user.password.request') }}" class="mb-2">@lang('Forgot
                            Password')?</a>
                    </p>
                    <p class="create-accounts">
                        <span>@lang('Don\'t have an account')? <a href="{{ route('ecommerce.user.register') }}"
    ...
    @auth
        @include('ecommerce::'.$activeTemplate.'user.partials.dp')
        <ul class="cl-white">
            @include('ecommerce::'.$activeTemplate.'user.partials.sidebar')
        </ul>
    @endauth
