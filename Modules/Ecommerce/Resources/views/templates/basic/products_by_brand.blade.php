 ...
 <div class="category-section padding-bottom padding-top">
    <div class="container">
        ...
        <div class="col-lg-12 mb-30">
            @include('ecommerce::'.$activeTemplate.'partials.empty_message', ['message' => __($empty_message)])
        </div>
        @else
            <div class="row">
                <div class="col-xl-3">
...
@push('breadcrumb-plugins')
    ...
    <li><a href="{{route('ecommerce.brands')}}">@lang('Brands')</a></li>
@endpush
    ...
    <script>
        (function($){
            ...
            function getFilteredData(min=null, max=null, category_id=null, perpage=`{{ $perpage }}`){
                ...
                $.ajax({
                    url: `{{ route('ecommerce.brands.filter', [$brand->id, slug($brand->name)] ) }}`,
                    method: "get",
