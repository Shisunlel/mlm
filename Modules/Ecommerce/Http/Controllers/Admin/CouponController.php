...
class CouponController extends Controller
{
    public function index()
    {
        ...
        $now = Carbon::now();
        return view('ecommerce::admin.coupons.index', compact('page_title', 'empty_message', 'coupons', 'now'));
    }
    ...
    public function create()
    {
        ...
        return view('ecommerce::admin.coupons.create', compact('page_title', 'categories'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ecommerce::admin.coupons.create', compact('page_title', 'categories', 'coupon'));
    }
