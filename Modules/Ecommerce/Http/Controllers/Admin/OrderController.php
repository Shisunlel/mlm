...
class OrderController extends Controller
{
    public function ordered()
    {
        ...
        $orders = $query->with(['user'])->orderBy('id', 'DESC')->paginate(getPaginate());

        return view('ecommerce::admin.order.ordered', compact('page_title', 'orders', 'empty_message'));
    }
    ...
    public function orderDetails($id)
    {
        ...
        $order = Order::where('id', $id)->with('user', 'orderDetail', 'appliedCoupon')->firstOrFail();
        return view('ecommerce::admin.order.order_details', compact('order', 'page_title'));
    }
}
