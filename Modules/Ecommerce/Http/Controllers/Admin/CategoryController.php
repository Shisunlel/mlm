...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        return view('ecommerce::admin.categories.index', compact('page_title', 'empty_message', 'categories'));
    }
    ...
    public function trashed()
    {
        ...
        return view('ecommerce::admin.categories.trashed', compact('page_title', 'empty_message', 'categories'));
    }
    ...
    public function categoryTrashedSearch(Request $request)
    {
        if ($request->search != null) {
            ...
            return redirect()->route('ecommerce.admin.categories.trashed');
        }
    }
