...
use Modules\Ecommerce\Entities\ProductAttribute;
use Modules\Ecommerce\Entities\ProductImage;
...
class ProductController extends Controller
{
    public function index()
    {
        ...
        return view('ecommerce::admin.products.index', compact('page_title', 'empty_message', 'products', 'now'));
    }
    ...
    public function productSearch(Request $request)
    {
        ...
        if ($request->search != null) {
            ...
            return redirect()->route('ecommerce.admin.product');
        }
    }
    ...
    public function create()
    {
        ...
        return view('ecommerce::admin.products.create', compact('page_title', 'categories', 'brands'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ecommerce::admin.products.create', compact('page_title', 'categories', 'brands', 'product', 'images'));
    }
    ...
    public function createAttribute($product_id)
    {
        ...
        return view('ecommerce::admin.products.attributes.create', compact('page_title', 'attributes', 'product_id', 'empty_message', 'existing_attributes', 'product_name'));
    }
    ...
    public function reviews()
    {
        ...
        return view('ecommerce::admin.products.reviews', compact('page_title', 'empty_message', 'reviews'));
    }
    ...
    public function reviewSerach(Request $request)
    {
        if ($request->key != null) {
            ...
            return redirect()->route('ecommerce.admin.product.reviews');
        }
    }
    ...
    public function addVariantImages($id)
    {
        ...
        return view('ecommerce::admin.products.attributes.add_variant_image', compact('page_title', 'variant', 'images', 'product_name'));
    }
