...
class ProductStockController extends Controller
{
    public function stockCreate($product_id)
    {
        ...
        return view('ecommerce::admin.products.stock.create', compact('page_title', 'data', 'product'));
    }
    ...
    public function stockLog($id)
    {
        ...
        return view('ecommerce::admin.products.stock.log', compact('page_title', 'empty_message', 'product_stock', 'stock_logs'));
    }
    ...
    public function stocks()
    {
        ...
        return view('ecommerce::admin.products.items_in_stock', compact('stock_data', 'page_title', 'empty_message'));
    }
