...
class OfferController extends Controller
{
    public function index()
    {
        ...
        return view('ecommerce::admin.offers.index', compact('page_title', 'empty_message', 'offers'));
    }

    public function create()
    {
        $page_title = "Create New Offer";
        return view('ecommerce::admin.offers.create', compact('page_title'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ecommerce::admin.offers.create', compact('page_title', 'offer'));
    }
