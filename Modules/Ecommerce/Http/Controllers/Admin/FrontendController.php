...
class FrontendController extends Controller
{
    ...
    public function templates()
    {
        ...
        return view('ecommerce::admin.frontend.templates', compact('page_title', 'templates', 'extra_templates'));
    ...
    public function seoEdit()
    {
        ...
        return view('ecommerce::admin.frontend.seo', compact('page_title', 'seo'));
    }

    public function frontendSections($key)
    {
        $section = @getEcomPageSections()->$key;
        if (!$section) {
            return abort(404);
        }
        ...
        return view('ecommerce::admin.frontend.index', compact('section', 'content', 'elements', 'key', 'page_title', 'empty_message'));
    }
    ...
    public function frontendContent(Request $request, $key)
    {
        ...
        $imgJson = @getEcomPageSections()->$key->$type->images;
    ...
    public function frontendElement($key, $id = null)
    {
        ...
        if ($id) {
            ...
            return view('ecommerce::admin.frontend.element', compact('section', 'key', 'page_title', 'data'));
        }
        return view('ecommerce::admin.frontend.element', compact('section', 'key', 'page_title'));
    }
