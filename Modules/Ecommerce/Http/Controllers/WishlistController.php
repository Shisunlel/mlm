...
class WishlistController extends Controller
{
    ...
    public function getWsihList()
    {
        ...
        return view('ecommerce::' . activeTemplate() . 'partials.wishlist_items', ['data' => $latest, 'empty_message' => $empty_message, 'more' => $more]);
    }
    ...
    public function wishList()
    {
        ...
        $page_title = 'Wishlist';
        $empty_message = 'No product in your wishlist';
        return view('ecommerce::' . activeTemplate() . 'wishlist', compact('page_title', 'wishlist_data', 'empty_message'));
    }
