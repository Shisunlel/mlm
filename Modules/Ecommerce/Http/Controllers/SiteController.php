...
use Modules\Ecommerce\Entities\AssignProductAttribute;
...
use Modules\Ecommerce\Entities\ProductStock;
use Modules\Ecommerce\Entities\Subscriber;
use Modules\Ecommerce\Entities\SupportAttachment;
use Modules\Ecommerce\Entities\SupportMessage;
use Modules\Ecommerce\Entities\SupportTicket;
...
class SiteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . 'home', $data);
    }
    ...
    public function productSearch(Request $request)
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . $view, compact('page_title', 'products', 'empty_message', 'search_key', 'category_id', 'perpage'));
    }
    ...
    public function products(Request $request)
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . $view, compact('products', 'perpage', 'brand', 'min_price', 'max_price', 'page_title', 'brands', 'min', 'max', 'category_id', 'empty_message'));
    }
    ...
    public function productsByCategory(Request $request, $id)
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . $view, compact('products', 'perpage', 'brand', 'min_price', 'max_price', 'page_title', 'empty_message', 'min', 'max', 'category', 'brands', 'seo_contents'));
    ...
    public function productsByBrand(Request $request, $id)
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . $view, compact('products', 'perpage', 'brand', 'min_price', 'max_price', 'page_title', 'empty_message', 'min', 'max', 'category_id', 'seo_contents'));
    ...
    public function productDetails($id, $order_id = null)
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . 'product_details', compact('product', 'page_title', 'review_available', 'related_products', 'discount', 'attributes', 'images', 'seo_contents'));
    }
    ...
    public function quickView(Request $request)
    {
        ...
        $page_title = 'Product Details';
        return view('ecommerce::' . $this->activeTemplate . 'partials.quick_view', compact('product', 'page_title', 'review_available', 'discount', 'attributes'));
    }
    ...
    public function brands()
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . 'brands', $data);
    }
    ...
    public function categories()
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . 'categories', $data);
    }

    public function contact()
    {
        $data['page_title'] = "Contact Us";
        return view('ecommerce::' . $this->activeTemplate . 'contact', $data);
    }
    ...
    public function contactSubmit(Request $request)
    {
        ...
        return redirect()->route('ecommerce.ticket.view', [$ticket->ticket])->withNotify($notify);
    }
    ...
    public function trackOrder()
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . 'order_track', compact('page_title'));
    }
    ...
    {
        $data = getModuleContent('about_page.content', true);
        $page_title = $data->data_values->page_title ?? '';

        return view('ecommerce::' . $this->activeTemplate . 'page', compact('page_title', 'data'));
    }

    public function faqs()
    {
        $data = getModuleContent('faq_page.content', true);
        $page_title = $data->data_values->page_title ?? '';
        return view('ecommerce::' . $this->activeTemplate . 'page', compact('page_title', 'data'));
    }
    ...
    public function compare()
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . 'compare', compact('page_title', 'compare_items', 'empty_message'));
    }
    ...
    public function loadMore(Request $request)
    {
        ...
        return view('ecommerce::' . $this->activeTemplate . 'partials.product_review', compact('reviews'));
    }
    ...
    public function getImageByVariant(Request $request)
    {
        ...
        if ($images->count() > 0) {
            return view('ecommerce::' . $this->activeTemplate . 'partials.variant_images', compact('images'));
        } else {
    ...
    public function printInvoice(Order $order)
    {
        ...
        return view('ecommerce::invoice.print', compact('page_title', 'order'));
    }
