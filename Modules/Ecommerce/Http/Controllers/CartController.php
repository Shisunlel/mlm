...
class CartController extends Controller
{
    ...
    public function getCart()
    {
        ...
        return view('ecommerce::' . activeTemplate() . 'partials.cart_items', ['data' => $latest, 'subtotal' => $subtotal, 'empty_message' => $empty_message, 'more' => $more, 'coupon' => $coupon]);
    }
    ...
    public function shoppingCart()
    {
        ...
        return view('ecommerce::' . activeTemplate() . 'cart', compact('page_title', 'data', 'empty_message'));
    }
    ...
    public function checkout()
    {
        ...
        $page_title = 'Checkout';
        return view('ecommerce::' . activeTemplate() . 'checkout', compact('page_title', 'shipping_methods'));
    }
